# Modern Asynchronous JavaScript - Notes Index
...
- [Chapter 5: Setting a Time Limit for Asynchronous Tasks. `Promise.any()`, `Promise.race()`](./05_setting_a_time_limit_for_async_tasks/notes.md)
